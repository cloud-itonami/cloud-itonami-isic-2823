(ns metalmachmfg.phase
  "Phase 0->3 staged rollout for the metallurgy-machinery (ISIC 2823)
  plant-operations coordination actor, illustrated with rolling-mill
  and casting-machinery manufacturing (rolling-mill stands, continuous
  casters, die-casting machines, extrusion presses, forging presses,
  ...
  consequence (a fabrication/assembly-test-bench-equipment maintenance
  window means production downtime, and the equipment ends up actually
  touched); it is always a human plant supervisor's call.
  `metalmachmfg.governor`'s `equipment-actuate-blocked-violations`
...
(defn verdict->disposition
  "Map a Metallurgy Machinery Plant Operations Governor verdict to a
