...
/* the compat skin centres the page on the body element itself; this
   console owns its own shell (.wrap), so hand the width back rather
   than nesting two containers. (No literal tag syntax in this comment:
   it would read as an unbalanced open tag to a naive HTML checker.) */
