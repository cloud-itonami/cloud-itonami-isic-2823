# Operator Quickstart — Manufacture of machinery for metallurgy

Shortest path from clone to a verified local dry-run for **ISIC 2823** (`cloud-itonami-isic-2823`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2823.git
cd cloud-itonami-isic-2823
```
...
- Blueprint governor key: `metallurgy-machinery-plant-operations-governor`
- Likely source path: `metalmachmfg.governor.cljc`
