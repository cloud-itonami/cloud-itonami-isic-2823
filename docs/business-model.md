# Business Model: Manufacture of machinery for metallurgy
...
## Classification
- Repository: `cloud-itonami-isic-2823` ([github.com/cloud-itonami/cloud-itonami-isic-2823](https://github.com/cloud-itonami/cloud-itonami-isic-2823))
- ISIC Rev.5: `2823` — Manufacture of machinery for metallurgy
- Domain: `:metallurgy-machinery/manufacturing`
- Social impact: :worker-safety :equipment-safety :structural-integrity-transparency :quality-defect-transparency
- Actor: `:metallurgy-machinery-plant-operations-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :metallurgy-machinery/manufacturing — who wants
...
One managed tenant (:metallurgy-machinery/manufacturing):
...
- Do not bypass the `:metallurgy-machinery-plant-operations-governor` for production decisions.
