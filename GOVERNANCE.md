...
`cloud-itonami-isic-2823` is an OSS open-business blueprint for
metallurgy-machinery plant operations coordination.

## Maintainers
Maintainers may merge changes that preserve these invariants:
- a fabrication/assembly-line-equipment action the governor refuses is never dispatched to hardware.
- the Metallurgy Machinery Plant Operations Governor remains independent of the advisor.
...
- bypassing fabrication/assembly-line-equipment-control or record policy checks
